...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    // Add result counts for contract recording
    ...
    // Add bot recording transaction hash (separate from existing transactionHash)
    ...
    // Add flag to indicate if recorded via new contract method
